...
class ForwardContext:
    ...
    nelssa_forward_context: dict[str, Any] = field(default_factory=dict)
...
def create_forward_context(
    ...
    nelssa_forward_context: dict[str, Any] | None = None,
    skip_compiled: bool = False,
):
    ...
    return ForwardContext(
        ...
        nelssa_forward_context=nelssa_forward_context or {},
    )
...
def set_forward_context(
    ...
    if nelssa_forward_context:
        platform_kwargs.update(nelssa_forward_context)
    nelssa_forward_context = platform_kwargs
