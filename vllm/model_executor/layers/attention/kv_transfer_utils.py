...
def maybe_transfer_kv_layer(func: Callable) -> Callable:
    ...
    def wrapper(*args, **kwargs):
        ...
        # HS: KV cache transfer
        # Long request ) CMM-Ax communication w/ cluster metadata transfer

        # [Decode node] Before attention, waiting for KV cache recieve
        # Todo: P/D disaggregated
        ...
        # [Prefill node] After attention, start KV cache sending
        # Todo: P/D disaggregated
        # (1) CMM-Ax node CPU offloading
        # (2) Transfer cluster metadata
