...
class NewRequestData:
    ...
    # Todo: preprocess
    nelssa_long_mask: bool = False
    head_size: int | None = None  # Number of head tokens for sparse KV cache
    tail_size: int | None = None  # Number of tail tokens for sparse KV cache
    ...
    def from_request(
        ...
        return cls(
            ...
            nelssa_long_mask=request.nelssa_long_mask,
            head_size=request.head_size,
            tail_size=request.tail_size,
        )
...
class SchedulerOutput:
    ...
    # Todo: clustering
    # Track requests that completed prefill in this step (for sparse KV clustering)
    prefill_complete_reqs: list[str] | None = None
    ...
    # Todo: preprocess
    nelssa_long_mask: dict[str, bool] = None
    head_size: dict[str, int | None] = None
    tail_size: dict[str, int | None] = None

    # Used for adjusting acceptance rate calculation.
    num_invalid_spec_tokens: dict[str, int] | None = None

    # Chunk info for middle token identification {is_first_chunk, is_last_chunk, middle_start, middle_end}
    chunk_info: dict[str, dict] | None = None
