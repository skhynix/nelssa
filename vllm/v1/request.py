...
class Request:
    def __init__(
        ...
        # Head KV stored in 'Request' field (4 tokens)
        self.nelssa_long_mask = False
        self.head_size: int | None = None
        self.tail_size: int | None = None

        # Sparse KV offloading state
        # Tracks the last position that was offloaded to CPU
        self.offloaded_until_pos: int = 0
